...
TRAIN_PATH = 'F:\\桌面\\project\\input\\train\\'
TRAIN_LABELS = 'F:\\桌面\\project\\input\\train_labels.csv'
SIZE_IMG = 96
EPOCHS = 10

model_path = 'F:\\桌面\\project\\input\\cancer_detection_resnet.h5'
...
test_path = 'F:\\桌面\\project\\input\\test\\'
df_test = pd.read_csv('F:\\桌面\\project\\input\\sample_submission.csv')
